...
class GdriveConnectorTest {

    GdriveConnector connector;
    ...
    @Test
    void runit() throws ConnectorException {
        connector.connect();
    ...
    void should_throw_exception_if_mandatory_input_is_empty() {
        ...
        parameters.put(GdriveConnector.DEFAULT_INPUT, "");
    ...
    void should_throw_exception_if_mandatory_input_is_not_a_string() {
        Map<String, Object> parameters = new HashMap<>();
        parameters.put(GdriveConnector.DEFAULT_INPUT, 38);
        connector.setInputParameters(parameters);
        assertThrows(ConnectorValidationException.class, () ->
                connector.validateInputParameters()
        );
    ...
    void should_create_output_for_valid_input() throws ConnectorException {
        Map<String, Object> parameters = new HashMap<>();
        parameters.put(GdriveConnector.DEFAULT_INPUT, "valid");
        connector.setInputParameters(parameters);
